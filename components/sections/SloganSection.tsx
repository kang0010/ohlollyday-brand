...
export function SloganSection() {
  return (
    <section id="slogan" className="px-16 pb-8 border-b border-[#e0e0e0]">

      {/* 메인 슬로건 */}
      <div className="mb-6">
        <div className="bg-[#ff6000] text-black px-16 py-12 mb-2 -mx-16">
      ...
      {/* 코어밸류 */}
      <div id="corevalue" className="grid grid-cols-4 gap-px bg-[#e0e0e0] -mx-16">
